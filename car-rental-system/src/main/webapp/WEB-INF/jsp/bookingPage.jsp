...
<body>
    ...
    <div class="form-container">
        ...
        <form:form action="/createBooking" method="post" modelAttribute="carBooking">
            ...
            <form:input path="fromDate" id="fromDate" class="input" placeholder="fromDate" type="date"/>
            <br /><br />

            <label class="label" for="toDate">Enter toDate:</label>
            <form:input path="toDate" id="toDate" class="input" placeholder="toDate" type="date"/>
            <br /><br />
